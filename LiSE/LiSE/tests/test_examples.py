...
from LiSE.examples import college, kobold, pathfind, polygons, sickle, wolfsheep
...
def test_wolfsheep(tmp_path):
    ...
    hand = EngineHandle(tmp_path, random_seed=69105, workers=0, threaded_triggers=False)
    hand.next_turn()
    hand.close()
