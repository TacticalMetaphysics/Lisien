...
def queries(table):
    ...
    r["load_node_rulebook_tick_to_end"] = node_rb_select.where(to_end_clause(ntab))
    r["load_node_rulebook_tick_to_tick"] = node_rb_select.where(to_tick_clause(ntab))
    ...
    r["load_portal_rulebook_tick_to_end"] = port_rb_select.where(to_end_clause(ptab))
    r["load_portal_rulebook_tick_to_tick"] = port_rb_select.where(to_tick_clause(ptab))
    ...
    r["load_rulebooks_tick_to_end"] = rbsel.where(generic_tick_to_end_clause(rbs))
    r["load_rulebooks_tick_to_tick"] = rbsel.where(generic_tick_to_tick_clause(rbs))
    ...
    r["load_rule_prereqs_tick_to_end"] = preqsel.where(generic_tick_to_end_clause(preq))
    r["load_rule_prereqs_tick_to_tick"] = preqsel.where(
        generic_tick_to_tick_clause(preq)
    )
    actsel = select(act.c.rule, act.c.branch, act.c.turn, act.c.tick, act.c.actions)
    r["load_rule_actions_tick_to_end"] = actsel.where(generic_tick_to_end_clause(act))
    r["load_rule_actions_tick_to_tick"] = actsel.where(generic_tick_to_tick_clause(act))
