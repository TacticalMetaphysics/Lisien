...
for minor in $(seq 12 14); do
    ...
    /usr/local/bin/python3.$minor -m pip install --root-user-action ignore Cython==0.29.34 tox twine
    USE_SDL3=0 USE_X11=1 /usr/local/bin/python3.$minor -m pip wheel . legacy-cgi setuptools git+https://github.com/kivy/buildozer
