...
class ScreenTest(ELiDEAppTest):
    def test_advance_time(self):
        ...
        idle_until(lambda: "timepanel" in screen.ids, 100, "timepanel never got id")
    ...
    def test_update(self):
        ...
        idle_until(lambda: 2 in graphboard.pawn, 100, "Never made pawn for thing 2")
        ...
        idle_until(
            lambda: app.engine.character["physical"].thing[2]["location"] == (1, 1),
            100,
            "Never relocated",
        )
        idle_until(
        ...
        idle_until(lambda: not app.edit_locked, 100, "Never unlocked")
        idle_until(
            lambda: app.engine.character["physical"].thing[2]["location"] == (0, 0),
            100,
            "Never relocated",
        )
