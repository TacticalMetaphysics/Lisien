...
class ControlTypePicker(Button):
    ...
    def build(self, *_):
        ...
        self.dropdown.bind(on_select=lambda instance, x: self.set_control(self.key, x))
        readoutbut = Button(
            text="readout",
            size_hint_y=None,
            height=self.height,
        ...
        readoutbut.bind(on_release=lambda instance: self.dropdown.select("readout"))
        ...
        textinbut.bind(on_release=lambda instance: self.dropdown.select("textinput"))
        ...
        togbut.bind(on_release=lambda instance: self.dropdown.select("togglebutton"))
        ...
        sliderbut.bind(on_release=lambda instance: self.dropdown.select("slider"))
