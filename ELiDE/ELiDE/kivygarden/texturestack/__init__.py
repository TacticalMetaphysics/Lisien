...
from kivy.graphics import InstructionGroup, PopMatrix, PushMatrix, Rectangle, Translate
from kivy.graphics.fbo import Fbo
from kivy.properties import AliasProperty, DictProperty, ListProperty, ObjectProperty
...
class TextureStack(Widget):
    ...
    offsets = AliasProperty(_get_offsets, _set_offsets, bind=("offxs", "offys"))
    ...
    with open("marsh_davies_island_bg.atlas") as bgf, open(
        ...
        pathses = zip(
            ...
            (
                ...
                for name in cycle(json.load(fgf)["marsh_davies_island_fg-0.png"].keys())
            ),
        )
