...
from kivy.properties import BooleanProperty, ObjectProperty, ReferenceListProperty
...
class CharMenu(BoxLayout):
    ...
    def on_screen(self, *_):
        ...
        self.bind(reciprocal_portal=self.screen.boardview.setter("reciprocal_portal"))
    ...
    def spot_from_dummy(self, dummy):
        ...
        if name not in gridboard.spot and isinstance(name, tuple) and len(name) == 2:
    ...
    def toggle_spot_cfg(self):
        ...
        if self.app.manager.current == "spotcfg":
            ...
            if self.app.spotcfg.prefix:
                ...
                dummyplace.num = dummynum(self.app.character, dummyplace.prefix) + 1
    ...
    def toggle_pawn_cfg(self):
        ...
        if self.app.manager.current == "pawncfg":
            ...
            if self.app.pawncfg.prefix:
                ...
                dummything.num = dummynum(self.app.character, dummything.prefix) + 1
    ...
    def new_character(self, but):
        ...
        self.app.chars.charsview.adapter.data = list(self.engine.character.keys())
