...
requirements = python3,kivy,msgpack,numpy,sqlite3,networkx,blinker,sqlalchemy,typing_extensions,tblib,pygments,lisien,elide,androidstorage4kivy,annotated-types,astor,android,pyjnius,python-osc,reslot,u-msgpack-python,attrs,more-itertools,zict
