...
requirements = python3,kivy,msgpack,numpy,sqlite3,networkx,astunparse,blinker,sqlalchemy,tblib,pygments,libbz2,liblzma,python-osc,lisien,elide,android,androidstorage4kivy
...
android.permissions = (name=android.permission.WRITE_EXTERNAL_STORAGE),(name=android.permission.INTERNET;maxSdkVersion=34),android.permission.FOREGROUND_SERVICE
