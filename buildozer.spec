...
requirements = python3,kivy,msgpack,numpy,sqlite3,networkx,blinker,sqlalchemy,typing_extensions,tblib,pygments,lisien,elide,androidstorage4kivy,annotated-types,android,pyjnius,python-osc,u-msgpack-python,attrs,more-itertools,zict
